...
echo "=========================================="
echo "EmbeddingGemma Triplet Fine-tuning"
echo "=========================================="
...
tmux send-keys -t "$SESSION_NAME" "uv run python $SCRIPT --config $CONFIG 2>&1 | tee $LOG_FILE" Enter
...
echo ""
echo "TensorBoard:"
echo "  tensorboard --logdir models/embeddinggemma-300m-triplet-adapted/runs"
echo ""
echo "MLflow:"
